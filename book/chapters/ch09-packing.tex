...
\chapterlead{Trong bài toán đóng gói, mệnh đề không xử lý trực tiếp với hình chữ
...
\section{Bài toán đóng gói (Packing problem) dải hai chiều}
...
Biểu diễn SAT thứ tự cho đóng gói dải đã được nghiên cứu trước đó cùng đối xứng,
...
quay và phá vỡ đối xứng chứng nhận 26 giá trị tối ưu trên 41 bài toán; phiên bản
...
\section{Bài toán đóng gói (Packing problem) vào khung chứa hai chiều}
...
phép gán và không chồng lấn giống bài toán đóng gói (packing problem) vào khung. Nếu gộp theo
...
cách phá vỡ đối xứng bền vững là buộc biến sử dụng tấm theo tiền tố và buộc chỉ
...
thước. Điểm chuyển giao sang các bài toán đóng gói (packing problem) khác là chuỗi mô-đun
\[
  \texttt{Assignment}
...
Mỗi ràng buộc phá vỡ đối xứng được gắn với một nhóm đối xứng cụ thể:
\begin{itemize}
...
\textcite{walsh2006symmetry,gent2006symmetry}; phép biểu diễn SAT cổ điển cho bài toán đóng gói (packing problem) khung 2D
...
\begin{enumerate}
  ...
  \item Phá vỡ đối xứng theo đúng phép hoán vị hoặc phản xạ của mô hình.
...
\begin{enumerate}
  ...
  \item So sánh số biến của xếp chồng và không xếp chồng trên \(n\) vật,
        \(k\) khung.
  \item Thiết kế ràng buộc phá vỡ đối xứng cho ba bản sao cùng loại và chứng minh
        mỗi quỹ đạo giữ một
        đại diện.
\end{enumerate}
