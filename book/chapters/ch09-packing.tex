...
\chapterlead{Trong bài toán xếp khối, mệnh đề không xử lý trực tiếp với hình chữ
nhật; mô hình làm việc với tọa độ, hướng đặt và các quan hệ tách. Chất lượng phép biểu diễn
phụ thuộc vào việc thiết kế giao diện phù hợp giữa ba lớp đó.}
...
\section{Bản đồ các phương pháp chính xác cho xếp khối}
...
sinh tập/cột, quy hoạch ràng buộc và các kỹ thuật nhánh--cận chuyên biệt
...
\begin{description}[style=nextline]
  ...
  trí tuyệt đối và xếp khối hoàn hảo khai thác nén tọa độ, tổng tập con và suy
  luận trên không gian trống
  \parencite{huang2013rectangle}.

  \item[Vị trí tương đối + tọa độ]
  Mỗi vật có tọa độ; mỗi cặp có \emph{witness variable} (biến làm chứng)
  trái/phải/trên/dưới. Biểu diễn thứ tự
  nén cận tọa độ, còn mệnh đề quan hệ xử lý phép tuyển.
\end{description}

Ngoài SAT, quy hoạch ràng buộc dùng \textsc{NoOverlap}/diffn, các phép chiếu
tích lũy và suy luận năng lượng; MIP dùng hằng số lớn \(M\), bất đẳng thức
tuyển hoặc mẫu phủ tập. Các phương pháp chính xác cho xếp khối trực giao còn
kết hợp cận, quan hệ trội và nhánh--cận chuyên dụng
\parencite{clautiaux2007orthogonal,clautiaux2008cp}.

\begin{center}
\captionof{table}{Các biểu diễn chính xác cho xếp khối hai chiều.}
...
Ba trục tạo nên đóng góp SAT cho xếp khối là nén miền tọa độ, làm mạnh lan
...
\]
Ta dùng các biến làm chứng \(l_{ij}\) và \(u_{ij}\):
\[
  l_{ij}\lor l_{ji}\lor u_{ij}\lor u_{ji},
\]
với quan hệ kéo theo từ từng biến làm chứng sang bất đẳng thức tương ứng. Các
biến làm chứng không cần loại trừ lẫn nhau: một vật có thể vừa ở bên trái vừa ở dưới vật
khác.
...
thứ tự và quan hệ vị trí được dùng trong SAT cho xếp khối; cách tổ chức quan hệ
này tiếp nối mô hình xếp khối dải của \textcite{soh2010strip}.
...
\(x_A+w_A=x_B=3\), nên biến làm chứng \(l_{AB}\) có thể nhận giá trị đúng.}
...
\]
Chỉ bất đẳng thức đầu đúng, nên \(l_{AB}=1\) là biến làm chứng tự nhiên. Nếu ép
...
\section{Biểu diễn thứ tự cho tọa độ}
...
Khi \(l_{ij}\) đóng vai trò biến làm chứng cho phép tuyển, mô-đun cần chiều
\[
  l_{ij}\rightarrow x_i+\widehat w_i\le x_j.
\]
Chiều ngược
...
Giả sử mỗi biến làm chứng \(l_{ij},u_{ij}\) kéo theo đúng bất đẳng thức hình học
của vật, và phép tuyển bốn biến làm chứng được thỏa cho mọi cặp vật trong cùng khung
chứa. Khi đó mọi bố trí giải mã từ mô hình \SAT đều không giao nhau.
\end{proposition}

\begin{proof}
Với một cặp \(i,j\), phép tuyển cho ít nhất một biến làm chứng đúng. Quan hệ kéo
theo của biến làm chứng đó cho một bất đẳng thức tách theo trục \(x\) hoặc \(y\). Vì vậy nội
thất hai hình chữ nhật rời nhau.
\end{proof}

\section{Bài toán xếp khối (Packing problem) dải hai chiều}
...
Biểu diễn SAT thứ tự cho xếp khối dải đã được nghiên cứu trước đó cùng đối xứng,
...
cận. Với xếp khối dải, thay \(H\) có thể làm thay đổi mạnh miền tọa độ và
...
\section{Bài toán xếp khối (Packing problem) vào khung chứa hai chiều}
...
định khung. Kiến trúc này tái sử dụng xếp khối dải nhưng phải ngăn vật vượt qua
đường biên \(qH\).
...
\end{tikzpicture}
\caption{Hai kiến trúc cho xếp khối vào khung: xếp chồng dùng một trục \(y\)
...
biểu diễn đơn lẻ: biến thứ tự giúp biểu diễn bất đẳng thức tọa độ, còn phá đối
...
phép gán và không chồng lấn giống bài toán xếp khối (packing problem) vào khung. Nếu gộp theo
...
\(\sum_bq_b\). Hai cách chia sẻ điều kiện nằm gọn, hướng đặt và không chồng
lấn; chúng chỉ khác ở lớp hàm mục tiêu.

\textcite{kieu2026cutting} cho thấy phép biểu diễn gọn với tọa độ thứ tự và đối
xứng theo bản sao/tấm đạt kết quả cạnh tranh trên bộ bài toán cắt tấm một kích
thước. Điểm chuyển giao sang các bài toán xếp khối (packing problem) khác là chuỗi mô-đun
\[
  \texttt{Assignment}
...
\textcite{walsh2006symmetry,gent2006symmetry}; phép biểu diễn SAT cổ điển cho bài toán xếp khối (packing problem) khung 2D
Packing có rotation có thể xem ở \textcite{soh2010binpacking}.

\section{Tách ảnh hưởng của phép biểu diễn, cận và quan hệ trội}
...
sang CNF. Phép so sánh CP, MIP và SAT chia sẻ cách chuẩn hóa bài toán và cận
...
\textbf{RelativePosition} tạo biến làm chứng trái/phải/trên/dưới.
...
\begin{enumerate}
  \item Chọn một quy ước tọa độ và duy trì quy ước này nhất quán trong toàn bộ phép biểu diễn.
  \item Dùng biến làm chứng cho phép tuyển hình học; không buộc biến làm chứng trở thành
