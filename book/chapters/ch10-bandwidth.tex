...
\begin{itemize}
  \item \textbf{cận lý thuyết đồ thị}: bậc, số ổn định, số sắc, đồ thị con
        đầy đủ (\emph{clique}) và cấu
        trúc lớp đồ thị;
  \item \textbf{phương pháp kinh nghiệm/siêu kinh nghiệm}: tìm kiếm cục bộ,
        kiêng kỵ (\emph{tabu}), lân cận biến đổi và thứ tự kiến tạo để tìm
...
\begin{tikzpicture}[satfig,x=8mm,y=7mm]
  ...
  \node[satlabel,text=Gold,align=center] at (9,-1.4)
    {dải chéo \(|a-b|<2\)\\trở thành các mệnh đề xung đột};
\end{tikzpicture}
...
Bản tiền công bố \textcite{truong2026cabp} xây dựng các phép mã hóa SAT cho CABP
...
\begin{enumerate}
  ...
  \item giải theo quy trình cận đơn điệu và lưu nghiệm chứng;
