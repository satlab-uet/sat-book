...
cần biểu diễn, còn bộ đếm dùng chung giảm phần biểu diễn lặp giữa các cửa sổ đó.
...
hệ giữa các đoạn. CNF có thể lớn hơn biểu diễn thứ tự, nhưng lan truyền trên bài
...
\(c(v)\le2\) hoặc \(c(v)\ge6\). Biểu diễn trực tiếp từng cặp phải cấm riêng
...
được các bài toán khó mà biểu diễn thứ tự không hoàn tất trong cùng giới hạn.
Giải tăng dần và đối xứng không có hiệu ứng đồng đều: lợi ích phụ thuộc vào họ
biểu diễn. Vì vậy thí nghiệm bóc tách nên dùng đơn vị
...
\begin{enumerate}
  ...
  \item chọn biểu diễn trực tiếp/thứ tự/khối theo hình dạng tập cấm;
...
\begin{summarybox}
\textbf{Bài học trung tâm.} Chọn biểu diễn trực tiếp, thứ tự hay theo khối không
