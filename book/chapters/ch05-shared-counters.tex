...
\emph{shared counter} (bộ đếm dùng chung) biến phần giao đó thành một mô-đun
có thể tái sử dụng.}
...
Mục tiêu của phép biểu diễn dùng chung là đưa chi phí về gần
\[
  O(nk)
\]
...
(thang bộ đếm dùng chung, SCL) xây các trạng thái AMO/AMZ trong khối và
...
\begin{theorem}[Tính đúng của phép biểu diễn cửa sổ dùng chung]
