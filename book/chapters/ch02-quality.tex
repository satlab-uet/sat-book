...
\begin{workedexample}{một bất đẳng thức trong Direct Encoding và thứ tự}
Cho \(u,v\in\set{0,\ldots,4}\) và \(u+2\le v\). Direct Encoding cấm từng cặp
\((a,b)\) với \(a+2>b\):
\[
  \neg x_{u,a}\lor\neg x_{v,b}.
\]
Order Encoding dùng \(o_{z,t}\leftrightarrow(z\ge t)\) và các mệnh đề
\[
