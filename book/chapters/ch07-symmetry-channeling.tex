...
\emph{Symmetry breaking} (phá vỡ đối xứng) thu gọn không gian tìm kiếm, còn
...
Các vị từ phá vỡ đối xứng tổng quát xây một điều kiện chọn đại diện cho các quỹ
...
ràng buộc phá vỡ đối xứng \parencite{aloul2003shatter}. Ở cấp mô hình, người thiết
kế đã biết ngữ nghĩa nên có thể viết ràng buộc ngắn hơn, chẳng hạn tiền tố
khung chứa đã dùng. Hai cách bổ sung nhau: phá vỡ đối xứng miền được áp dụng trước;
...
Các lớp ràng buộc phá vỡ đối xứng được ghép theo thứ tự. Ràng buộc miền làm thay
đổi nhóm tự đẳng cấu của đồ thị; bộ phá vỡ đối xứng tự động vì thế chạy trên công
...
Phá vỡ đối xứng thêm công thức \(B\) sao cho mỗi quỹ đạo còn ít nhất một
đại diện:
\[
  \forall s\in S,\qquad
...
phá vỡ đối xứng nhỏ, rẻ và phù hợp với mô hình thường hữu ích hơn việc cố gắng biểu diễn
...
Chứng minh một ràng buộc phá vỡ đối xứng bằng phép hoán vị hoặc phép phản xạ đưa mọi nghiệm bị
...
Trong bài toán đóng gói (packing problem), biến chiếm chỗ theo từng ô có thể tạo nhiều cách diễn
giải một hình chữ nhật; biến tọa độ và hướng đặt biểu diễn hình học trực tiếp hơn.

Nguyên tắc chung là:
\[
  \text{không Order Encoding nếu thứ tự không thuộc nghiệm.}
\]
Sau bước chọn biến, các ràng buộc phá vỡ đối xứng xử lý nhóm đối xứng còn lại.
Cách tiếp cận đó giảm cả số biến lẫn số mệnh đề; bước phá vỡ đối xứng tiếp tục
giảm số mô hình.

\section{Bốn mẫu phá vỡ đối xứng}
...
Mỗi ràng buộc phá vỡ đối xứng đổi cấu trúc mệnh đề, thứ tự quyết định và các xung
đột học được. Nên so sánh ít nhất ba cấu hình: không phá vỡ đối xứng, ràng buộc rẻ
...
\[
  A\lor B\lor C\lor D.
\]
Trong bài toán đóng gói, hai hình \(i,j\) không chồng lấn khi ít nhất một quan hệ đúng:
\[
...
Từ góc nhìn chuyển CSP sang SAT, biến quan hệ nằm giữa Direct Encoding và mã
...
\section{Order Encoding và các literal so sánh}

Cho biến nguyên \(z\in\{0,\ldots,U\}\). Order Encoding dùng
\[
  o_{z,t}=1
...
trúc dịch chuyển này có tính địa phương cao và phù hợp với bài toán đóng gói (packing problem)
...
\begin{workedexample}{Liên kết Direct Encoding--thứ tự cho một giá trị nguyên}
Cho \(z\in\{0,1,2,3,4\}\). Direct Encoding có \(d_a\Leftrightarrow(z=a)\);
Order Encoding có \(o_t\Leftrightarrow(z\ge t)\). Hai góc nhìn được nối bởi
\[
...
và miền thời gian của chúng giao nhau. Trong bài toán đóng gói, mọi cặp vật cùng khung
...
\begin{enumerate}
  ...
  \item thêm ràng buộc đếm hoặc Shared Counter cho tài nguyên;
  \item thêm các ràng buộc phá vỡ đối xứng có chứng minh quỹ đạo;
...
\begin{summarybox}
\begin{enumerate}
  \item Loại đối xứng biểu diễn trước khi thêm các mệnh đề phá vỡ đối xứng.
  ...
  \item Order Encoding làm các cận dịch chuyển trở thành mệnh đề đơn giản.
...
\begin{enumerate}
  ...
  \item Cho một ràng buộc phản xạ trong bài toán đóng gói (packing problem) dải và nêu điều kiện
