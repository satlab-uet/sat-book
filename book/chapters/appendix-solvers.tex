...
\begin{itemize}
  ...
  \item \textbf{CaDiCaL} \parencite{biere2019cadical}: Bộ giải CDCL hiện đại do Armin Biere phát triển, tích hợp sâu các kỹ thuật xử lý trước và trong khi giải (\emph{in-processing}, \emph{vivification}, \emph{subsumption}) cùng cơ chế xuất chứng minh \UNSAT (\emph{proof logging} DRAT/LRAT).
