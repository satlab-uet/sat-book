...
Một đặc trưng không có hiệu ứng độc lập khi nó thay đổi giao diện của phép biểu diễn.
...
\begin{enumerate}
  \item Thiết kế thí nghiệm bóc tách \(2\times2\) cho bộ biểu diễn và phá đối xứng.
