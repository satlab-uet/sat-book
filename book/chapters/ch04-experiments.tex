...
\begin{itemize}
  ...
  \item \textbf{bằng chứng có kiểm soát}: \emph{ablation}
        (thí nghiệm bóc tách) giữ cố định các yếu tố khác;
...
dữ liệu như vậy được gọi là \emph{right-censored} (kiểm duyệt phải).
...
\begin{itemize}
  ...
  \item \emph{cactus plot} (biểu đồ xương rồng);
...
không phải dữ liệu của bài toán; nó là số khởi tạo bộ sinh số giả ngẫu nhiên
...
Nếu bộ mã hóa là tất định nhưng bộ giải có yếu tố ngẫu nhiên, hạt giống ngẫu
...
\textbf{Yếu tố.} Bộ mã hóa, bộ giải, đặc trưng, họ bài toán, hạt giống ngẫu nhiên.\\
