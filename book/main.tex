...
{\sffamily\fontsize{18}{24}\selectfont\color{white}%
 Cho Các Bài Toán Tối Ưu Hóa Tổ Hợp\par}

\vspace{32mm}

{\sffamily\fontsize{11}{18}\selectfont\color{white}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
 Khảo cứu nền tảng và các họ mã hóa SAT\par\vspace{7pt}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
 Nguyên lý thiết kế và tái sử dụng cấu trúc\par\vspace{7pt}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
...
\vspace{10mm}
{\sffamily\bfseries\fontsize{8}{10}\selectfont\color{Gold}%
 SATLAB RESEARCH GROUP\enspace·\enspace 2026\par}
\vspace{16mm}
