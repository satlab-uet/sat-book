...
%%==========================================================
%% TITLE PAGE — Springer "Algorithms & Combinatorics" style
%%==========================================================
\begin{titlepage}
\thispagestyle{empty}
\begin{tikzpicture}[remember picture,overlay]
  ...
  %--- Blue vertical left-margin bar ---
  \fill[Blue]
    (current page.north west)
    rectangle ([xshift=20mm]current page.south west);
  %--- Gold rule below series label ---
  \draw[Gold,line width=1.4pt]
    ([xshift=28mm,yshift=-36mm]current page.north west) --
    ([xshift=-22mm,yshift=-36mm]current page.north east);
  %--- Gold rule above author block ---
  \draw[Gold,line width=1.4pt]
    ([xshift=28mm,yshift=52mm]current page.south west) --
    ([xshift=-22mm,yshift=52mm]current page.south east);
  %--- Centered SATLAB · 2026 precisely under the gold rule ---
  \node[anchor=north,color=Gold,font=\sffamily\bfseries\fontsize{11}{14}\selectfont]
    at ([xshift=3mm,yshift=42mm]current page.south)
    {SATLAB\enspace·\enspace 2026};
\end{tikzpicture}

\vspace*{18mm}
{\sffamily\bfseries\fontsize{11}{14}\selectfont\color{Gold}%
 SÁCH CHUYÊN KHẢO\enspace·\enspace KHOA HỌC MÁY TÍNH\par}

\vspace{22mm}

{\sffamily\bfseries\fontsize{44}{50}\selectfont\color{white}%
 BIỂU DIỄN SAT TỐI ƯU\par}

\vspace{10mm}

{\sffamily\bfseries\fontsize{20}{26}\selectfont\color{white}%
 CHO CÁC BÀI TOÁN TỐI ƯU HÓA TỔ HỢP\par}

\vspace{30mm}

{\sffamily\fontsize{12.5}{20}\selectfont\color{white}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
 Khảo cứu nền tảng và các họ mã hóa SAT\par\vspace{8pt}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
 Nguyên lý thiết kế và tái sử dụng cấu trúc\par\vspace{8pt}%
 {\color{Gold}\rule{10mm}{0.8pt}}\enspace
 Nghiên cứu tình huống trong tối ưu tổ hợp\par}

\vfill

{\sffamily\bfseries\fontsize{13.5}{19}\selectfont\color{white}%
 Tô Văn Khánh\enspace·\enspace
 Kiều Văn Tuyên\enspace·\enspace
 Trương Xuân Hiếu\par}
\vspace{4pt}
{\sffamily\fontsize{11.5}{16}\selectfont\color{white}%
 Vũ Thanh Hương\enspace·\enspace
 Đào Xuân Nghĩa\enspace·\enspace
...
\vspace{18mm}
{\sffamily\bfseries\fontsize{11}{14}\selectfont\color{Ink!80}%
 SATLAB\enspace·\enspace 2026\par}
\par}
\vfill
